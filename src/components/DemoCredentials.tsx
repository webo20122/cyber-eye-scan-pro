      ...
      <div className="text-sm text-gray-600 space-y-3">
        ...
        <div className="bg-gradient-to-r from-blue-50 to-purple-50 p-4 rounded-lg space-y-2 border border-blue-100">
          ...
          <div className="flex items-center justify-between">
            ...
            <code className="text-xs bg-white px-2 py-1 rounded">analyst</code>
          </div>
          <div className="flex items-center justify-between">
            <span className="font-medium text-gray-700">Password:</span>
            <code className="text-xs bg-white px-2 py-1 rounded">analyst123</code>
          </div>
          <hr className="my-2 border-gray-200" />
          <div className="flex items-center justify-between">
            <span className="font-medium text-gray-700">Pentester:</span>
            <code className="text-xs bg-white px-2 py-1 rounded">pentest</code>
          </div>
          <div className="flex items-center justify-between">
            <span className="font-medium text-gray-700">Password:</span>
            <code className="text-xs bg-white px-2 py-1 rounded">pentest123</code>
          </div>
        </div>
      </div>
    </div>
